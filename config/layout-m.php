...
return [
    ...
    // Demo Assets
    'resources' => [
        'favicon' => 'm/media/img/logo/favicon.ico',
        'fonts' => [
            'google' => [
                'families' => [
        ...
        'css' => [
            'm/plugins/global/plugins.bundle.css',
            //'m/plugins/custom/prismjs/prismjs.bundle.css',
            'm/css/app.css',
            'm/css/style.bundle.css',
        ],
        'js' => [
            'm/plugins/global/plugins.bundle.js',
            //'m/plugins/custom/prismjs/prismjs.bundle.js',
            'm/js/scripts.bundle.js',
        ],
    ],
