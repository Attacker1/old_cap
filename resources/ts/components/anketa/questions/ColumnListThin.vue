<template>
  <div class="answers">
    ...
    <div class="answers__body" :class="question.multiple ? 'answers__body_checkbox_column answers__body_checkbox' : 'answers__body_radio_column answers__body_radio'">
...
export default class ColumnListThin extends Mixins(questionMixin) {}
</script>
