...
<div style="max-width:600px;min-width:500px; margin: 0 auto;background: #fff;">
    <div style="padding:30px;">
        <h2>Привет!</h2>
        <p>Вы получили данное письмо, потому что это ТЕСТ почтовой системы
        </p>
        <p>
            <small style="color: lightgrey"><i>Если вы не делали данный запрос, просто проигнорируйте это
                    письмо.</i></small>
        </p>
    </div>
</div>
