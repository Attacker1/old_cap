...
<div class="float-right">
    <a href="{{ route('admin.catalog.attributes.create') }}"><button class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Добавить</button></a>
</div>
@endsection
        ...
        $(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'preset', name: 'preset',searchable: false, orderable: false},
                    {data: 'visible', name: 'visible', searchable: false, orderable: false},
                    {data: 'action', name: 'action2', class: 'w-15'},
