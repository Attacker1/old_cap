...
<div class="float-right">
    <a href="{{ route('admin.manage.users.create') }}"><button class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Добавить</button></a>
</div>
@endsection
        ...
        $(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'disabled', name: 'disabled',searchable: false, orderable: true},
