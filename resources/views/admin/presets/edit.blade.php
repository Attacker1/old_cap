...
@section('content')
    ...
    <form name="form" method="post" action="{{ route('admin.catalog.presets.update',$data->id) }}">
        {{ csrf_field() }}
                                    ...
                                    <div class="col-sm-12 parent">
                                        <div class="row ">
                                            <div class="col-sm-4 form-group">
                                                <input class="form-control" name="params[name][]" value="{{ @$data->params['name'][$k] }}" placeholder="Значение" autocomplete="off" required>
                                            </div>
