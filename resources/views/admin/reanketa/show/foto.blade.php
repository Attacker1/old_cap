<div class="tab-pane" id="kt_tab_pane_3" role="tabpanel">
    ...
    <div class="row">
        ...
        @foreach($arr_fotoes as $foto_url)
            @foreach($foto_url as $foto)
            <div class="col-lg-4 col-md-6 col-sm-8 pb-6 mt-3">
                ...
                <div style="position:relative;" class="m-3 p-3 resizeable" >
                    <a class="modal-show-foto" data-url="{{ $foto }}" style="cursor:pointer">
                        <img class="card-img img-fluid mb-1" src="{{ $foto }}">
                    </a>
                </div>
            </div>
            @endforeach
