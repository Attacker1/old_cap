...
<div class="float-right">
    <a href="{{ route('manage.roles.create') }}"><button class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Добавить роль</button></a>
    <a href="{{ route('manage.permissions.create') }}"><button class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Добавить права</button></a>
    <a href="{{ route('manage.permissions.index') }}"><button class="btn btn-sm btn-info"><i class="fa fa-list"></i> Все права</button></a>
</div>
@endsection
