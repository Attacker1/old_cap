...
@section('content')
    ...
    <form name="form" method="post" action="{{ route('manage.roles.create') }}">
        {{ csrf_field() }}
        ...
        <div class="row">
            ...
            @foreach($permissions as $k=>$v)
                <div class="form-group custom-control custom-switch custom-control-inline">
                    <input type="checkbox" name="permission[{{ $k }}]" value="1" class="custom-control-input" id="permission-id-{{ $k }}">
