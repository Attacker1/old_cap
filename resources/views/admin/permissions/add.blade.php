...
@section('content')
    ...
    <form name="form" method="post" action="{{ route('manage.permissions.create') }}">
        {{ csrf_field() }}
    ...
    <div class="row">
        ...
        <div class="input-group mb-3 col-sm-12">
            ...
            <input type="text" name="slug" id="slug" value="{{ old('slug') }}"  class="form-control " autocomplete="off"  aria-label="" aria-describedby="slug_label" required>
        </div>
    </div>
        <div class="row">
            <div class="col-sm-12">
