...
<div class="float-right">
    <a href="{{ route('sber.statuses.create') }}"><button class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Добавить статус</button></a>
</div>
@endsection
