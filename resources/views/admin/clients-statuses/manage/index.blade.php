...
<div class="float-right">
    <a href="{{ route('client.statuses.create') }}"><button class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Добавить статус</button></a>
</div>
@endsection
...
@section('content')
    ...
    <div class="card card-custom gutter-b">
        ...
        <table id="datatable"
            ...
            <tr>
                <th>ID</th>
                <th>Наимен. статуса клиента</th>
                <th>Статусы системы</th>
                <th>Действие</th>
            </tr>
            </thead>
        </table>
    ...
    <script>
        $(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url:'{!! route('client.statuses.index') !!}',
                    method: "POST",
                    data: function(d){
                        // d.range = $('#range').val();
                    }
                ...
                columns: [
                    ...
                    {data: 'name', name: 'name',},
                    {data: 'statuses', name: 'statuses',searchable: false, orderable: false},
