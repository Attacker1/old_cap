...
@section('actions')
    <div class="float-right">
        <a href="{{ route('client.statuses.index') }}"><i class="fas fa-window-close text-danger"></i></a>
    </div>
@endsection
...
@section('content')
    ...
    <form name="form" method="post" action="{{ route('client.statuses.update',$data->id) }}">
        {{ csrf_field() }}
        ...
        <div class="row">
            ...
            <div class="input-group mb-3 col-sm-12">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="name_label">Cтатус для клиента: </span>
                </div>
