...
class Metronic
{
    ...
    {
        if (config('layout-m.resources.fonts.google.families')) {
            $fonts = config('layout-m.resources.fonts.google.families');
    ...
    public static function initThemes()
    {
        ...
        $themes[] = 'm/css/themes/layout/header/base/'.config('layout-m.header.self.theme').'.css';
        $themes[] = 'm/css/themes/layout/header/menu/'.config('layout-m.header.menu.desktop.submenu.theme').'.css';
        $themes[] = 'm/css/themes/layout/aside/'.config('layout-m.aside.self.theme').'.css';

        if (config('layout-m.aside.self.display')) {
            $themes[] = 'm/css/themes/layout/brand/'.config('layout-m.brand.self.theme').'.css';
        } else {
            $themes[] = 'm/css/themes/layout/brand/'.config('layout-m.header.self.theme').'.css';
        }
