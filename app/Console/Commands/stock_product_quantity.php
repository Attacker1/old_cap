...
class stock_product_quantity extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:stock_product_quantity';
     ...
     * @var string
     */
    protected $description = 'Stock Product Quantity: остатки';
    ...
    public function handle()
    {
        ...
        $rows = $product->import('stock');
        Log::channel('stock_cron')->info('Обновление остатков: обновлено - ' . $rows ." | Время вып: " . $this->execution() );
